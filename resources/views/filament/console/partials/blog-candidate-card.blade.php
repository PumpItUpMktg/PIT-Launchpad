{{-- One candidate card. Expects $c (a candidate row from BlogBoard::candidates). Extracted so the
     grouped board (silo → local-first, capped) can render each row without duplicating the markup. --}}
