<x-lp.shell
    ...
    <style>
        ...
        .ix-watch { margin-top:16px; }
        .ix-watch table { width:100%; border-collapse:collapse; font-size:13px; }
        .ix-watch th { text-align:left; font-size:10px; text-transform:uppercase; letter-spacing:.05em; color:var(--ink-soft); font-weight:700; padding:8px 16px; border-top:1px solid var(--line); }
        .ix-watch td { padding:8px 16px; border-top:1px solid #EEF2F4; vertical-align:middle; }
        .ix-watch td.date { font-variant-numeric:tabular-nums; white-space:nowrap; }
        .ix-watch tr.is-inspected td { background:#FFF8EA; }
        .ix-watch tr.is-indexed td { background:#EAF5F1; }
        .ix-watch .t a { color:var(--ink); text-decoration:none; font-weight:600; }
