    ...
    @unless ($started)
        <div class="fi-section rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10">
            <p class="mb-4 text-sm text-gray-600 dark:text-gray-400">
                ...
                When there's enough, you'll extract and save the seed + voice profile.
            </p>
        ...
        <div class="flex flex-col gap-4">
            ...
            @if ($preview)
                <div class="rounded-xl bg-white p-4 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10">
                    <h3 class="mb-2 text-sm font-semibold text-gray-700 dark:text-gray-200">Extracted</h3>
                    <pre class="overflow-x-auto rounded-lg bg-gray-950/90 p-3 text-xs text-gray-100">{{ json_encode($preview, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) }}</pre>
