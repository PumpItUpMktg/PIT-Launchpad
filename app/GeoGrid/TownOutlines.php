...
/**
 * Town boundary rings for colouring a town's own shape on a map (§ Town Rank service areas): the Census
 * TIGERweb county-subdivision / place polygons ({@see MunicipalityGazetteer::townPolygons()}), read
 * through the cache so a town is fetched once a month, not once a page view. Best-effort: a gazetteer
 * failure yields no shapes and the map falls back to a dot for that town.
 */
final class TownOutlines
{
