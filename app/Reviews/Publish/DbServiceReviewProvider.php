 ...
 * review_service pivot), mapped to the shipped {@see LocalReview} DTO. Town is each review's OWN town (never
 * the owning location's city). Empty ⇒ the section omits. Display only — NO rating/review structured data (§8).
 */
