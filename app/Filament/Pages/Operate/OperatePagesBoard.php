...
abstract class OperatePagesBoard extends OperatePage
{
     ...
     * Site-level (not family-specific), so the consolidated board offers it on every tab.
     */
    protected function refreshRankingsAction(): Action
    {
        return Action::make('refreshRankings')
