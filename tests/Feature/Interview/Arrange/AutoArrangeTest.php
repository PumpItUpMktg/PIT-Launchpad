...
test('a re-run does not thrash: the second arrange is a no-op', function () {
    ...
    $arranger = new AutoArranger($this->fake, new CrossSiloDedup(0.85, 0.15), new SubClusterDetector(0.60), new FoldTargetAssigner(0.70), new KeywordAssigner(0.90), new FloorReconciler);
