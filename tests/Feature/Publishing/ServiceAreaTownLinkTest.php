...
it('still falls back to the Areas page for a served town with no location page of its own', function () {
    $site = Site::factory()->create(['domain_url' => 'https://spg.test']);
    Location::factory()->create(['site_id' => $site->id, 'county_geoids' => ['42045']]);
    townLinkGazetteer('42', '42045', 'Delaware County');
    ...
    expect($marple['url'])->toBe('https://spg.test/areas-we-serve');   // by-design fallback preserved
});
