...
final class StyleStore
{
    ...
    private const CURATED_PALETTES = [
        'clean' => ['base' => '#ffffff', 'surface' => '#f1f5f9', 'contrast' => '#0f172a', 'muted' => '#475569', 'border' => '#e2e8f0', 'primary' => '#123B6B', 'accent' => '#1D6FD6', 'on-accent' => '#ffffff', 'accent-ink' => '#1d6fd6', 'button' => '#1D6FD6', 'on-button' => '#ffffff'],
        'bold' => ['base' => '#ffffff', 'surface' => '#f5f3f2', 'contrast' => '#1a1a1a', 'muted' => '#57534e', 'border' => '#e7e5e4', 'primary' => '#111827', 'accent' => '#E4572E', 'on-accent' => '#111827', 'accent-ink' => '#b64625', 'button' => '#E4572E', 'on-button' => '#111827'],
        'warm' => ['base' => '#fffdf8', 'surface' => '#f6efe3', 'contrast' => '#2b2620', 'muted' => '#6b5d4f', 'border' => '#e7dcc9', 'primary' => '#7C4A24', 'accent' => '#E08D3C', 'on-accent' => '#111827', 'accent-ink' => '#9d632a', 'button' => '#C9702A', 'on-button' => '#111827'],
        'fresh' => ['base' => '#ffffff', 'surface' => '#eefaf6', 'contrast' => '#0f2a26', 'muted' => '#4b6b64', 'border' => '#d5eae4', 'primary' => '#0B5D52', 'accent' => '#14B8A6', 'on-accent' => '#111827', 'accent-ink' => '#0e8174', 'button' => '#0EA5A0', 'on-button' => '#111827'],
        'premium' => ['base' => '#0f1620', 'surface' => '#17202e', 'contrast' => '#e8edf4', 'muted' => '#9aa7bc', 'border' => '#263241', 'primary' => '#D4AF37', 'accent' => '#E7C55A', 'on-accent' => '#111827', 'accent-ink' => '#e7c55a', 'button' => '#C9A227', 'on-button' => '#111827'],
        'forest' => ['base' => '#ffffff', 'surface' => '#f0f4ef', 'contrast' => '#1c2b22', 'muted' => '#52645a', 'border' => '#dce6da', 'primary' => '#1E5233', 'accent' => '#4C9A2A', 'on-accent' => '#111827', 'accent-ink' => '#3d7b22', 'button' => '#3E7D2B', 'on-button' => '#ffffff'],
        'slate' => ['base' => '#ffffff', 'surface' => '#f2f4f7', 'contrast' => '#1f2937', 'muted' => '#64748b', 'border' => '#e2e8f0', 'primary' => '#334155', 'accent' => '#F97316', 'on-accent' => '#111827', 'accent-ink' => '#ae510f', 'button' => '#F97316', 'on-button' => '#111827'],
        'coastal' => ['base' => '#fbfeff', 'surface' => '#eaf4f7', 'contrast' => '#14343d', 'muted' => '#4e6c74', 'border' => '#d3e6ea', 'primary' => '#226C82', 'accent' => '#E0A458', 'on-accent' => '#111827', 'accent-ink' => '#866235', 'button' => '#226C82', 'on-button' => '#ffffff'],
        'crimson' => ['base' => '#ffffff', 'surface' => '#f7f2f2', 'contrast' => '#1a1414', 'muted' => '#6b5555', 'border' => '#ecdcdc', 'primary' => '#8C1D2C', 'accent' => '#C8102E', 'on-accent' => '#ffffff', 'accent-ink' => '#c8102e', 'button' => '#C8102E', 'on-button' => '#ffffff'],
        'midnight' => ['base' => '#0b1220', 'surface' => '#131c2e', 'contrast' => '#eaf1fb', 'muted' => '#93a4be', 'border' => '#22304a', 'primary' => '#4D97E8', 'accent' => '#38BDF8', 'on-accent' => '#111827', 'accent-ink' => '#38bdf8', 'button' => '#2F86E0', 'on-button' => '#111827'],
    ];
